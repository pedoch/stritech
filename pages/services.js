            ...
            <div className={styles.block}>
              ...
              <div className={[styles.service, styles.reverseWrap].join(' ')}>
                <div className={styles.text} data-aos="fade-left" style={{ textAlign: 'left' }}>
                  ...
                  <p>
                    Here at StriTech we pride ourselves in giving you simplicity but also innovation
                    on the wave of a mouse.
                  </p>
                  <p>
                    Our resourceful designers use worldclass tools and resources to bring the ideas
                    of forward thinking clients to light. They create user friendly designs while
            ...
            <div className={styles.block}>
              ...
              <div className={[styles.service].join(' ')}>
                ...
                <div className={styles.text} data-aos="fade-right" style={{ textAlign: 'right' }}>
                  ...
                  <p>
                    Our brilliant engineers take designs and bring them to life using the best tools
                    out there.
                  </p>
                  <p>
                    They create lightweight, functional, efficient and easy to use web and mobile
                    applications while meeting modern client and user requirements.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className={styles.block}>
              ...
              <div className={[styles.service, styles.reverseWrap].join(' ')}>
                <div className={styles.text} data-aos="fade-left" style={{ textAlign: 'left' }}>
                  ...
                  <p>
                    We provide reliable platforms that can link buyers directly to their favourite
                    stores, allowing them to order goods directly to their door step
                  </p>
                  <p>
                    We use CMS platforms like Shopify and WordPress to create long lasting
                    e-commerce sites that would help small to large businesses increase their
                    customers base.
                  </p>
                </div>
            ...
            <div className={styles.block}>
              ...
              <div className={[styles.service].join(' ')}>
                ...
                <div className={styles.text} data-aos="fade-right" style={{ textAlign: 'right' }}>
                  ...
                  <p>
                    We fix up web and mobile applications according to your specifications and help
                    you maintain your code base, keeping you the site modern, scalable and robust.
                  </p>
                </div>
              </div>
            </div>
